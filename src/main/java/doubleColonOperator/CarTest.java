...
public class CarTest {
    ...
    public static void main(String[] args) {
        ...
        /*
        ----What happens if you have 3 parameter or more?
        Then you need to make your own interface because there isn't any ready to use
        functional interface that java supplies
         */
